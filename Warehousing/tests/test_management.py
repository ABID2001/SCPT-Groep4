...
from ..code.api.mainManagement.Management import Management
from .data_init import TestData

'''
set PYTHONPATH=%PYTHONPATH%;c:/Users/Frank/SCPT-Groep4
python -m unittest Warehousing/tests/test_management.py
python -m unittest -v Warehousing/tests/test_management.py
'''

#python -m unittest Warehousing/tests/test_management.py
#om alle testen te runnen

#python -m unittest path/to/test_file.py.TestCaseName
#specifieke test case runnen
