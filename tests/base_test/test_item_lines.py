...
##pytest tests/base_test/test_item_lines.py

@pytest.fixture
def test_base():
    test_data = TestData.mock_data_item_lines()
...
def test_add(test_base):
    ...
    assert test_base.get_one(7)["name"] == "New Item Line"
...
def test_get_one(test_base):
    ...
    assert test_base.get_one(1)["name"] == "Electronics"
...
def test_update(test_base):
    ...
    assert test_base.get_one(1)["name"] == "Updated Item Line"
